...
├── Homeworks/                  # Homework Write-Ups
├── Notes/                      # Lecture Notes
├── Midterm 1 Cheat Sheet.tex   # Midterm 1 Reference Sheet
├── Midterm 2 Cheat Sheet.tex   # Midterm 2 Reference Sheet
├── course-handouts.sty         # Shared LaTeX Style
└── math-commands-preamble.sty  # Shared LaTeX Macros
```
